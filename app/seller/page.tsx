...
export const metadata: Metadata = {
  title: "Seller Dashboard | Nagore Shopping",
  description: "Seller dashboard for Nagore Shopping",
}
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>Recent sales from the last 24 hours</CardDescription>
          </CardHeader>
          <CardContent>
            <RecentSales />
          </CardContent>
